		   ...
		   <div class="col-sm-8 header-left">
					 ...
					 <div class="menu">
                        ...
                        <li><a href="../gallery.html">Resorts</a></li> -->
						    	...
						    	<li><a href="404.html">Join With our Team</a></li>
								<div class="clearfix"></div>
							</ul>
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  ...
					  <li class="active"><a href="#tab1" data-toggle="tab">Breakfast</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Lunch
					  </a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Dinner</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">American</a></li>
					   <li class="active"><a href="#tab1" data-toggle="tab">Chinease</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Thai</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Asian</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">Arabian</a></li>
					  <li class="active"><a href="#tab1" data-toggle="tab">Bangladeshi</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Snacks</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Fruits & Vegetables</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">Fast Food</a></li>

					  <li class="active"><a href="#tab1" data-toggle="tab">Sweets</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Caffe</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Soft Drinks</a></li>  
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
										<img src="images/hi/big_bun.png" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Bun</a>(100 g)</h6>							
										</div>
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="5" data-name="Lays" data-summary="summary 5" data-price="0.70" data-quantity="1" data-image="images/hi/big_bun.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal6" class="offer-img">
										<img src="images/hi/bug.png" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Burger</a>(100 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.70</em></p>
											  <div class="block">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="6" data-name="Kurkure" data-summary="summary 6" data-price="0.70" data-quantity="1" data-image="images/hi/bug.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal7" class="offer-img">
										<img src="images/hi/cak0.png" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.php">Cake</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal8" class="offer-img">
										<img src="images/hi/cheese.png" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">cheese</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
