...
function checkReloading() {
    if (window.location.hash=="products.php") {
...
<style>
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDbJnEtnqB1SRiOwWdcoZAoqBgh2KM6_eA&callback=initMap">
    </script>
</head>
<body> 
	<!-- banner -->
	<!-- <div class="banner about-w3bnr"> -->
        ...
        <div class="container">
          <!-- <div class="w3ls-header-left">
            <p>Free home delivery at your doorstep For Above TK 500</p>
          </div> -->
   ...
   <div class="banner">
   	  <div class="container_wrap">
            ...
            <form method="post" action="#">
             <input type="text" autocomplete="off"  placeholder="Search Tourism Area..." name="search1"/>
   	       ...
   	       <div class="dropdown-buttons">
				      <!-- <div class="dropdown-button">
					      <select class="" tabindex="9" data-settings='{"wrapperClass":"flat"}'>

                  			<option value="0">Facility Type</option>	
      						<option value="1">Hotels</option>
      						<option value="2">Resorts</option>
      						<option value="3">Restaurant </option>
      						<option value="4">Traditional Food</option>
	...
	<div class="container">	
		<ol class="breadcrumb w3l-crumbs">
			<li><a href="#"><i class="fa fa-home"></i> Your Location</a></li> 
			<li class="active"></li>
		</ol>
	</div>
	    <div id="map" style="margin-top: 10px; height: 250px; width: 100%;"></div>
		...
		<div class="container">
			<div class="col-md-9 product-w3ls-right"> 
				<div class="product-top">
					<h4>Restaurant Collection in Sylhet</h4>
					<ul> 
				...
				<div class="products-row">
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<a href="spicy_web/web/orders.php"><img src="images/shyl/pan.jpg" class="img-responsive" alt="img"></a>
									<div class="agile-product-text">              
										<h5>Panshi</h5>  
									</div> 
								</div>
								<div class="back">
									<a href="kitchen/index.php"><h4>Panshi</h4>
									<p> Indian,Asian,Bangladeshi, AC, NON AC,Sylhet</p>
									<p>KIDS, FAMILY</p> </a>
								</div>
							</div>
						</div> 
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									...
									<img src="images/shyl/eatopia.jpg" class="img-responsive" alt="img"> 
								</div>
								<div class="back">
									<a href="kitchen/index.php"><h4>Eathopia</h4>
									<p>International, AC, NON AC, Area</p>
									<p>KIDS, FAMILY</p> </a>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<a href="spicy_web/web/orders.php"><img src="images/shyl/bhujon-bari.jpg" class="img-responsive" alt="img"></a>
									<div class="agile-product-text">              
										<h5>Bhujonbari</h5>  
									</div> 
								</div>
								<div class="back">
									<a href="kitchen/index.php"><h4>Bhujon-bari</h4>
									<p>Bangladeshi, AC, NON AC, Area</p>
									<p>KIDS, FAMILY</p> </a>
			...
			<div class="col-md-3 rsidebar">
				<div class="rsidebar-top">
					...
					<div class="slider-left">
						...
						<div class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" onclick="toggleAutoRefresh(this);" id="reloadCB"><i></i>Bangladeshi</label>
					...
					<div class="slider-left">
						...
						<div class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" onclick="toggleAutoRefresh(this);" id="reloadCB"><i></i>Custom Order with taste
							</label>
					...
					<div class="slider-left">
						...
						<div class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" onclick="toggleAutoRefresh(this);" id="reloadCB"><i></i>Buffet</label>
					...
					<div class="sidebar-row">
						<h4>DISCOUNTS</h4>
						<div class="row row1 scroll-pane">  
							<label class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" onclick="toggleAutoRefresh(this);" id="reloadCB"><i></i>30% - 20% (2)</label>
